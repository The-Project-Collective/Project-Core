...
public abstract class CoreFishEntity extends CoreAquaticAnimalEntity implements Bucketable {
    ...
    protected CoreFishEntity(EntityType<? extends AnimalEntity> entityType, World world,
        ...
        super(entityType, world, doesAge, getsAngry, doesBreed, hasEnrichment, hasGender, hasHunger, hasAPack, canBeTamed, hasVariants, doesSleep, getsTired);
