...
public abstract class CoreSchoolingFishEntity extends CoreFishEntity {
    ...
    protected CoreSchoolingFishEntity(EntityType<? extends AnimalEntity> entityType, World world, boolean doesAge, boolean getsAngry, boolean doesBreed, boolean hasGender, boolean hasHunger, boolean hasAPack, boolean canBeTamed, boolean hasVariants, boolean canBeBucketed) {
        super(entityType, world, doesAge, getsAngry, doesBreed, hasGender, hasHunger, hasAPack, canBeTamed, hasVariants, canBeBucketed);
    }
