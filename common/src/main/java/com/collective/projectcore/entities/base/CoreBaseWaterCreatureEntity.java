...
public abstract class CoreBaseWaterCreatureEntity extends CoreBaseEntity {

    public static final int MIN_AMBIENT_SOUND_DELAY = 120;

    protected CoreBaseWaterCreatureEntity(EntityType<? extends CoreBaseWaterCreatureEntity> entityType, World world) {
