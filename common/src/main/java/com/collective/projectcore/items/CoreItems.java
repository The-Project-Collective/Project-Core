...
public class CoreItems {
    ...
    // Hormones
    public static final RegistrySupplier<Item> GROWTH_BOOSTING_HORMONE = ITEMS.register("growth_boosting_hormone", () -> new CoreBaseItem(getItemSettings("growth_boosting_hormone", new Item.Settings().maxCount(16).arch$tab(getHusbandryItemsGroup()))));
    public static final RegistrySupplier<Item> GROWTH_STUNTING_HORMONE = ITEMS.register("growth_stunting_hormone", () -> new CoreBaseItem(getItemSettings("growth_stunting_hormone", new Item.Settings().maxCount(16).arch$tab(getHusbandryItemsGroup()))));
    public static final RegistrySupplier<Item> FERTILITY_TREATMENT = ITEMS.register("fertility_treatment", () -> new CoreBaseItem(getItemSettings("fertility_treatment", new Item.Settings().maxCount(16).arch$tab(getHusbandryItemsGroup()))));
    public static final RegistrySupplier<Item> CONTRACEPTIVE_TREATMENT = ITEMS.register("contraceptive_treatment", () -> new CoreBaseItem(getItemSettings("contraceptive_treatment", new Item.Settings().maxCount(16).arch$tab(getHusbandryItemsGroup()))));

    // Creature Compendium
    public static final RegistrySupplier<Item> CREATURE_COMPENDIUM = ITEMS.register("creature_compendium", () -> new CompendiumItem(getItemSettings("creature_compendium", new Item.Settings().maxCount(1).arch$tab(getHusbandryItemsGroup()))));



    // === MISCELLANEOUS ===

    public static final RegistrySupplier<Item> DEV_TOOL = ITEMS.register("dev_tool", () -> new CoreBaseItem(getItemSettings("dev_tool", new Item.Settings().maxCount(1).arch$tab(CoreTabGroups.PROJECT_ITEMS))));
