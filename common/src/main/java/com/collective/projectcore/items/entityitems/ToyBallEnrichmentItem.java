...
public class ToyBallEnrichmentItem extends Item {

    public int woolType;

    public ToyBallEnrichmentItem(Settings settings, int woolType) {
        super(settings);
    ...
    public ActionResult use(World world, PlayerEntity player, Hand hand) {
        ...
        if (!world.isClient()) {
            ...
            if (hit.getType() == HitResult.Type.BLOCK) {
                ...
                world.playSound(null, spawnPos, SoundEvents.BLOCK_WOOL_PLACE, SoundCategory.BLOCKS, 1.0F, 1.0F);
